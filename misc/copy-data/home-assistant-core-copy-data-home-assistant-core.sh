...
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/SergeyKodolov/proxmox-helper-scripts/main/misc/copy-data/home-assistant-core-copy-data-home-assistant-core.sh)"
