...
qm set $VMID \
  -scsi0 "$DISK_REF" \
  -boot order=scsi0 \
  -description "<div align='center'><a href='https://Helper-Scripts.com'><img src='https://raw.githubusercontent.com/SergeyKodolov/proxmox-helper-scripts/main/misc/images/logo-81x112.png'/></a>
